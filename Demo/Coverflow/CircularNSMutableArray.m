...
#import "CircularNSMutableArray.h"
...
- (NSString *)description {
    ...
    NSMutableString *const description = [[NSMutableString alloc] initWithFormat:@"<%@ %p capacity=%lu, count=%lu (%@",
                                          NSStringFromClass([self class]), self, (unsigned long)_capacity, (unsigned long)_count, multiline ? @"\n" : @""];
